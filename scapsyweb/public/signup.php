...
body{
    margin: 0;
    padding: 0;
    background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url(images/blackred.jpg);
...
$sql = "INSERT INTO `signup` (`id`, `firstname`, `lastname`, `username`, `password`, `email`)
VALUES (NULL, '$newFirstName', '$newLastName', '$newusername', '$newpassword', '$newemail' )";
